...
class NewsArticles extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('Status,  Views, Useful, Unuseful,City,Uid,CateId,ActType,NewHot', 'numerical', 'integerOnly'=>true),
			...
			array('Tags, Description ,Content,CreatedDate, ActiveStartDate,ActiveEndDate,UpdatedDate,ActType,Target,NewHot', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('Id, Title, Tags, Content,City, Status, CreatedDate, UpdatedDate, UserId,  CateId, SmallImage, BigImage,ActType,Target,NewHot,recommand', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		is_array($this->recommand) && $recommand=implode(',',$this->recommand);
        //var_dump($recommand);exit;
		...
		isset($recommand) && $criteria->compare('t.recommand',$recommand,true);
	/* 	
