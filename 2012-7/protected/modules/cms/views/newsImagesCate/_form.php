...
<?php $form=$this->beginWidget('CActiveForm', array(
   ...
   <?php if(isset($Pictures)&&is_array($Pictures)){
      ...
      <a  target="_blank"  href="<?php echo Yii::app()->request->BaseUrl."/files/uploadfiles/".$val['Image'];?>"><img width="100" height="100" src="<?php echo Yii::app()->request->BaseUrl."/files/uploadfiles/".$val['Image'];?>"></a><br>
