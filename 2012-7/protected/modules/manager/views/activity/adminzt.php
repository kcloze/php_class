...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'activity-grid',
	'dataProvider'=>$model->searchAct(),
	'filter'=>$model,
	'columns'=>array(
		array('name'=>'id', 'headerHtmlOptions'=>array('width'=>50)),
		array('name'=>'name',
			'type'=>'html',
			'value'=>'CHtml::link($data->name,array("activityresource/adminzt","ActivityResource[activityId]"=>$data->id))', 
		...
		array(
			...
			'buttons'=>array(
				'button_1'=>array(
					...
					'url'=>'Yii::app()->controller->createUrl("activityresource/adminzt",array("ActivityResource[activityId]"=>$data->primaryKey))',
				),
			),
