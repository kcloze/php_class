...
class Controller extends CController
{
    ...
    */
    ...
    public function init()
    {
        ...
        $this->clientScript->registerScriptFile('https://ajax.googleapis.com/ajax/libs/jquery/1.4.4/jquery.min.js');
        $this->clientScript->registerScriptFile('https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.6/jquery-ui.min.js');
