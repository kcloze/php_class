 ...
 * @since 1.0
 */
class CZHLinkPager extends CBasePager
{
	const CSS_FIRST_PAGE='首页';
	const CSS_LAST_PAGE='末页';
	const CSS_PREVIOUS_PAGE='上页';
	const CSS_NEXT_PAGE='下页';
	...
	public function init()
	{
		if($this->nextPageLabel===null)
			$this->nextPageLabel=Yii::t('yii','下页 &gt;');
		if($this->prevPageLabel===null)
			$this->prevPageLabel=Yii::t('yii','&lt; 上页');
